...
import './ButtonsCadastroEmpresa.css';


function ButtonsCadastroEmpresa() {
  ...
  const handleSuccessClick = () => {
    ...
    setTimeout(() => {
      ...
      window.location.href = '/cadastroAnalise';
...
export default ButtonsCadastroEmpresa;
